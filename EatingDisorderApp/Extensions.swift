...
extension UIView{
    ...
    //Container for image, text and line for login and signUp  ~Louis Deguito June 14,2019
...
//Textfield for login and signUp ~Louis Deguito June 14,2019
...
//Background color for login and signup ~Louis Deguito June 14,2019
extension UIColor {
    static func rgb(red: CGFloat, green: CGFloat, blue: CGFloat) -> UIColor {
        return UIColor(red: red/255, green: green/255, blue: blue/255, alpha: 1)
    }
    
    //background color (changes numbers to change color)
    static func mainBlue() -> UIColor {
        return UIColor.rgb(red: 64, green: 193, blue: 215)
    }
}
