...
class LoginController: UIViewController {
    ...
    //Properties
    // LOGO for login ~Louis Deguito June 14,2019
    let logoImageView: UIImageView = {
        let im = UIImageView()
        im.contentMode = .scaleAspectFit
        im.clipsToBounds = true
        im.image = #imageLiteral(resourceName: "ic_person_outline_white_2x")  //insert LOGO here
        return im
    }()
    ...
    //Don't have an account button June 15,2019
